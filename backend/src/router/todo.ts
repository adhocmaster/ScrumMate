...
const createStory = express.Router()
createStory.post('/api/sprint/:sprintId/create', async (req, res) => {
...
const editOrMoveStory = express.Router()
editOrMoveStory.post('/api/sprint/:sprintId/story/:storyId/edit', async (req, res) => {
...
export {
	createStory as createStory,
	editOrMoveStory as editStory,
}
